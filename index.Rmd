--- 
title: "🚸 IndyCrash Data"
author: "Daniel P. Riggins"
date: "`r Sys.Date()`"
bibliography:
- book.bib
- packages.bib
description: Data prep for automobile crashes in Indiana
documentclass: book
link-citations: yes
...
### Issue One -- ARIES data is separated into annual reports:

Solution -- We combine all ARIES datasets from annual reports into a unified database that covers 2007 to present.

### Issue Two -- Each year's table has records that mix observational units:
